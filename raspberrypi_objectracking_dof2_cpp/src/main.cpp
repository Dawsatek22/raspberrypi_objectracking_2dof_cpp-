...
int positionx; //  value for the x direction servo
int positiony; //  value for the y direction servo
int centerx = 120; // is the value of the center x value that was calculated
...
track.set_pwm(pinx,0,servoval); 
track.set_pwm(piny,180,servoval); 
...
std::cout << "position of error" << errory <<'\n';
