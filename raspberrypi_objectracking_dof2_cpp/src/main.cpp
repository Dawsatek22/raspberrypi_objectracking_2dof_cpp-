...
the x and y direction with servos
*/
...
int positionx = 0; //  value for the x direction servo
int positiony = 18.; //  value for the y direction servo
int centerx = 91; // is the value of the center x value that was calculated
int centery = 43; // is the value of the center y value that was calculated
...
int piny = 1; // the pin for the y direction
using namespace cv;
...
//  servos of x and y direction  is calibrated
track.set_pwm(pinx,positionx,servoval); 
track.set_pwm(piny,positiony,servoval); 
std::cout << "servo is set to start angle"<< '\n';
sleep(2);
...
// below checks if the frame video frame is availabe
 ...
 for (std::size_t i = 0; i < contours.size(); ++i) {
        ...
        y_medium = int(box.y + box.height/ 2   ); // is the y direction converted into a int
...
int errorx = x_medium/6; // supossed to be the offset of the x direction
 int errory = y_medium/6; // supossed to be the offset of the y direction
//position = error;

std::cout << "position of center" << centery <<'\n';
std::cout << "position of error X" << errorx <<'\n';
std::cout << "position of error Y" << errory <<'\n';
std::cout << "position of y_medium" << x_medium <<'\n';
...
positionx = 180;
std::cout << "positionx of servos is reached 180" << '\n';
...
positionx = 0;
std::cout << "positionx of servos is reached 0" << '\n';
...
positiony = 90;
std::cout << "position of servos is reached 70" << '\n';
 ...
 track.set_pwm(pinx,positionx,servoval); // moves servos acording to the positionx value
 track.set_pwm(piny,positiony,servoval); // moves servos acording to the positiony value
std::cout << "angle of x direction ="<< positionx <<'\n';
std::cout << "angle of y direction ="<< positiony <<'\n';
